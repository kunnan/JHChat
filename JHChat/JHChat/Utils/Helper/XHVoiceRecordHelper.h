...
typedef void(^XHCountDownNum)(float countDownNum);
...
@property (nonatomic, copy) XHCountDownNum countDownNum;
...
@property (nonatomic) float startCountDownNum;  // 开始倒计时的数字，8
