...
- (void)viewDidLoad {
    ...
    self.collectionView.backgroundColor = [UIColor colorWithRed:0.230 green:0.230 blue:0.235 alpha:1.000];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    MWGridCell *cell = nil;
    if([_browser.delegate respondsToSelector:@selector(lzMWGridPhotoBrowser:collectionView:cellForItemAtIndexPath:)]){
        cell = [_browser.delegate lzMWGridPhotoBrowser:_browser collectionView:collectionView cellForItemAtIndexPath:indexPath];
        if(cell!=nil){
            return cell;
        }
    }
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    if([_browser.delegate respondsToSelector:@selector(lzMWGridPhotoBrowser:didSelectIndexPath:)]){
        [_browser.delegate lzMWGridPhotoBrowser:_browser didSelectIndexPath:indexPath];
    }
    else {
