...
//顶部ScrollView高度
static const CGFloat TopScrollViewHeight = 31.0f;
...
-(void)layoutSubviews
{
    ...
    _mainScrollView.contentSize = CGSizeMake(self.bounds.size.width * [_views count], 0);
    //分配子view的frame
...
-(void)updateButtons
{
    ...
    if (_adjustBtnSize2Screen) {
        for (NSInteger i = 0; i<_buttons.count; i++) {
            ...
            float btnWidth = (_topScrollView.bounds.size.width - 2*margin)/_views.count;
