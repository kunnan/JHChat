...
- (void)sd_setImageWithURL:(nullable NSURL *)url
		  ...
		  placeholderImage:(nullable UIImage *)placeholder
				 cachePath:(nullable NSString *)cachePath cacheKey:(nullable NSString *)cacheKey{
	[self sd_setImageWithURL:url forState:state placeholderImage:placeholder options:0 cachePath:cachePath cacheKey:cacheKey completed:nil];
...
- (void)sd_setImageWithURL:(nullable NSURL *)url
	...
	[self sd_setImageWithURL:url forState:state placeholderImage:placeholder options:0 cachePath:cachePath cacheKey:cacheKey completed:completedBlock];
...
- (void)sd_setBackgroundImageWithURL:(nullable NSURL *)url
					...
					placeholderImage:(nullable UIImage *)placeholder
						   cachePath:(nullable NSString *)cachePath cacheKey:(nullable NSString *)cacheKey{
	[self sd_setBackgroundImageWithURL:url forState:state placeholderImage:placeholder options:0 cachePath:cachePath cacheKey:cacheKey completed:nil];
}
...
- (void)sd_setBackgroundImageWithURL:(nullable NSURL *)url
					...
					placeholderImage:(nullable UIImage *)placeholder
						   cachePath:(nullable NSString *)cachePath cacheKey:(nullable NSString *)cacheKey
						   completed:(nullable SDExternalCompletionBlock)completedBlock{
	[self sd_setBackgroundImageWithURL:url forState:state placeholderImage:placeholder options:0 cachePath:cachePath cacheKey:cacheKey completed:completedBlock];
