...
- (void)sd_internalSetImageWithURL:(nullable NSURL *)url
		  placeholderImage:(nullable UIImage *)placeholder
			 ...
			 setImageBlock:(nullable SDSetImageBlock)setImageBlock
				 ...
				 completed:(nullable SDExternalCompletionBlock)completedBlock{
	return[self sd_internalSetImageWithURL:url placeholderImage:placeholder options:options operationKey:operationKey setImageBlock:setImageBlock progress:progressBlock completed:completedBlock cachePath:cachePath cacheKey:cacheKey context:nil];
}
...
//		}
		...
		SDWebImageManager *manager = [SDWebImageManager sharedManager:cachePath];
		//        if(cachePath){
		//            sharedManager.imageCache.diskCachePath = cachePath;
		//        }
		if(cacheKey){
