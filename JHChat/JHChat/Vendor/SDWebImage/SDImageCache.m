...
+ (SDImageCache *)sharedImageCache:(NSString *)cachePath  {
	...
	if([[instanceDic allKeys] containsObject:cachePath]){
		SDImageCache *instance =  [instanceDic objectForKey:cachePath];
		return instance;
	}
	else {
		SDImageCache *instance = [[SDImageCache alloc] init];;
		instance.diskCachePath = cachePath;
