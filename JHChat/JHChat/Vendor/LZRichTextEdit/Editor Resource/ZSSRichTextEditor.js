...
// 设置字体大小
zss_editor.setFont = function(fontSize) {
...
zss_editor.updateImage = function(url,title, alt) {
...
zss_editor.insertImage = function(url,title, alt) {
    zss_editor.restorerange();
    var html = '<img src="'+url+'" title="'+title+'" alt="'+alt+'" width="90%" height="auto"/>';
