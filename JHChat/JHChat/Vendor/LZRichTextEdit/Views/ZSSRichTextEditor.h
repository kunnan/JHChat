...
static NSString * const ZSSRichTextEditorToolbarFont = @"com.zedsaid.toolbaritem.font";
 ...
 */
@interface ZSSRichTextEditor : JHBaseViewController <UIWebViewDelegate, HRColorPickerViewControllerDelegate, UITextViewDelegate>
