...
//    }
    ...
    UIGraphicsBeginImageContext(CGSizeMake(newsizeWidth, newsizeHeight));
...
- (AVMutableVideoComposition *)fixedCompositionWithAsset:(AVAsset *)videoAsset {
    ...
    if (degrees != 0) {
        ...
        CGAffineTransform mixedTransform = CGAffineTransformIdentity; //modify by wch on 2018-06-08
