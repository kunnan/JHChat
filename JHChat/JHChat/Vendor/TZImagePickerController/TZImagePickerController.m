...
//        self.navigationBar.barTintColor = [UIColor colorWithRed:(34/255.0) green:(34/255.0)  blue:(34/255.0) alpha:1.0];
        self.navigationBar.barTintColor = [UIColor colorWithWhite:0.918 alpha:1.000];

        self.navigationBar.tintColor = [UIColor colorWithRed:0 / 255.0f green:122.0f / 255.0f blue:255.0f / 255.0f alpha:1.0f];
...
//    textAttrs[NSFontAttributeName] = self.barItemTextFont;
    ...
    textAttrs[NSForegroundColorAttributeName] = [UIColor colorWithRed:0 / 255.0f green:122.0f / 255.0f blue:255.0f / 255.0f alpha:1.0f];
...
- (instancetype)initWithDelegate:(id<TZImagePickerControllerDelegate>)delegate {
    return [self initWithMaxImagesCount:0 columnNumber:4 delegate:delegate pushPhotoPickerVc:YES];
}
...
- (instancetype)initWithMaxImagesCount:(NSInteger)maxImagesCount columnNumber:(NSInteger)columnNumber delegate:(id<TZImagePickerControllerDelegate>)delegate pushPhotoPickerVc:(BOOL)pushPhotoPickerVc {
    ...
    if (self) {
        self.maxImagesCount = maxImagesCount > 0 ? maxImagesCount : 20; // Default is 9 / 默认最大可选9张图片
...
//        NSString *title=[NSBundle tz_localizedStringForKey:@"Back"];
//        
//        //       根据按钮名称计算高度和宽度
...
//        backArrowImg.image=[UIImage imageNamedFromMyBundle:@"top_left_arrow"];
//        backArrowImg.userInteractionEnabled = YES;
//        UITapGestureRecognizer*tapGesture = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(popViewControllerAnimated:)];
//        [backArrowImg addGestureRecognizer:tapGesture];
//        
//        [leftView addSubview:backBtn];
//        [leftView addSubview:backArrowImg];
//        leftView.frame = CGRectMake(0, 0, backBtn.frame.size.width, tmpSize.height);
